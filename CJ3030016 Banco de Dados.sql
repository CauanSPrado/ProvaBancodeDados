...
-- Nome do aluno: Cauan Gabriel Dos Santos Do Prado
-- Data da prova:
-----------------------------------------------------------------------------------
...
CREATE DATABASE LOJAMARIACJ3030016;
GO


-- Habilita o contexto do banco de dados
USE LOJAMARIACJ3030016;
GO
...
SELECT 
    ...
    (P.ValorUnitario * IP.Quantidade) AS [Valor Total],
    PD.PrazoEntrega AS [Prazo de Entrega],
    V.NomeVendedor AS [Nome do Vendedor]
FROM 
    CLIENTES C
JOIN 
    PEDIDOS PD ON C.CodigoCliente = PD.CodigoCliente
JOIN 
...
DROP DATABASE LOJAMARIACJ3030016;
GO
